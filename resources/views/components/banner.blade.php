...
<div x-data="{
    ...
    class="py-3 text-white duration-500 bg-teal-600 lg:shadow-md lg:rounded-sm" x-cloak data-pan="discord-button">
    <div class="flex items-center justify-center gap-10 px-6 lg:justify-between">
        ...
        {{-- V2 Banner --}}
        <a href="{{ route('docs.upgrading') }}" class="flex items-center gap-2 text-sm text-white">
            <x-icon name="gift" />
            <strong class="font-semibold">You're viewing the TallCraftUI
