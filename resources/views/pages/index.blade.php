                    ...
                    <x-card data-pan="form-card">
                        ...
                        <x-card-content>
                            ...
                            <form wire:submit="createUser" class="space-y-4">
                                <x-input data-pan="form-input-field" label='Name *' wire:model="name" placeholder="Name"
                                    icon="user" />
                    ...
                    <x-card class="col-span-full lg:col-span-5">
                        ...
                        <x-card-content>
                            <div class="flex flex-wrap items-center justify-between gap-2">
                                ...
                                <x-button data-pan="drawer-button" x-on:click="$wire.openDrawer = true" label="Drawer"
                                    sm />
                            </div>
