        ...
        <div class="grid grid-cols-12 py-12 gap-y-8 lg:gap-x-8 md:py-16">
            <aside class="col-span-full lg:col-span-5">
                ...
                <h4 class="mb-6 text-lg text-gray-600 dark:text-gray-300 sm:text-xl">
                    TallCraftUI is a Laravel blade UI components library for the TALL Stack (TailwindCSS, Alpine.js, Laravel, Livewire) projects, offering <span class="border-b-2 pb-0.5 border-primary">25+ beautifully crafted</span>, customizable components.
                </h4>

                <div class="flex flex-col items-center gap-y-4 gap-x-5 sm:flex-row">
                    <x-button :link="route('docs.installation')" label="Get Started" class="w-full py-3 sm:w-fit sm:py-2.5" />
                    <x-button external link="https://github.com/developermithu/tallcraftui" outline class="w-full py-3 sm:w-fit sm:py-2.5">
                    ...
                    <x-card>
                        ...
                        <x-card-content>
                            ...
                            <form wire:submit="createUser" class="space-y-4">
                                ...
                                <x-password label="Password *" wire:model="password" generate />
                                <x-color-picker label="Color picker *" wire:model="color" />
                                <x-textarea label="Textarea" wire:model="textarea" class="min-h-16" auto-resize />
                ...
                <div class="grid items-start grid-cols-12 gap-4">
                    ...
                    <x-card class="col-span-full lg:col-span-5">
                        ...
                        <x-card-content>
                            ...
                            <x-button class="w-full" @click="$wire.openModal = true" label="Open Modal" outline />
